...
<html>
    <head>
        ...
        <title>Casos pendientes de revisión</title>
    ...
    <body>
        ...
        <h1 class="text-center mt-3 mb-3" style="margin-left:70px;">Listado de casos por revisar</h1>

        <p class="text-center mt-3 mb-3" style="font-size:18px;margin-left:70px;" >En esta página se muestran los casos que, 
            están listos para ser aprobados o rechazados.</p>
        ...
        <sql:query var="casos" dataSource="jdbc/mysql">
            ...
            where caso.id_empleado=? and estado_caso.Descripción='Esperando aprobación de área solicitante'
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center flex-wrap">
                                    <a href="revisar_caso.jsp?id_caso=${casos[0]}" >Ingresar a Revision</a>
                                </div>
                            </td>
